...
#変数選択
lm_train_j1_2<-dplyr::select(lm_train_j1, y2, tv_num, capa, setu2, home, kyuujitu,home_lank,away_lank)
lm_train_j2_2<-dplyr::select(lm_train_j2, y2, tv_num, capa, setu2, home, kyuujitu,home_lank,away_lank)
lm_test_j1_2<-dplyr::select(lm_test_j1, tv_num, capa, setu2, home, kyuujitu,home_lank,away_lank)
lm_test_j2_2<-dplyr::select(lm_test_j2, tv_num, capa, setu2, home, kyuujitu,home_lank,away_lank)
...
###CSV出力(ヘッダーなし)
write.table(submit_all, file="C:/study/JLeague/submit/submit_20171201_1_lm.csv",
...
#########変数選択 rmseを確認したいとき用２
lm_train_j1_2<-dplyr::select(lm_train_j1, y, tv_num, capa, setu2, home, kyuujitu,home_lank,away_lank)
lm_train_j2_2<-dplyr::select(lm_train_j2, y, tv_num, capa, setu2, home, kyuujitu,home_lank,away_lank)
# J1線形回帰、10分割交差検定
model_j1 <- train(
  y ~ .,
  data = lm_train_j1_2,
